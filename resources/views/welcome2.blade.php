...
<body>
  ...
  <nav class="d-flex align-items-center justify-content-between p-2 bg-primary text-light">
  ...
  <main class="pb-5">
    ...
    <section class="dnone profile-section container p-4 bg-light rounded shadow-sm my-4" id="profile">
      <h2 class="text-primary mb-4">User Profile</h2>

      <div class="row">
        <!-- Profile Picture and User Info -->
        <div class="col-md-4 text-center mb-4">
          <img src="https://placehold.co/150" alt="User Logo" class="rounded-circle mb-3 profile-pic"
            style="width: 150px; height: 150px" />
          <h3 class="text-primary UserName">UserName</h3>
          <p class="text-secondary"><strong>Username:</strong>
          <p class="UserUsername">UserUsername</p>
          </p>
          <p class="text-secondary"><strong>Balance:</strong>
    ...
    <section class="withdraw-section container p-4 pb-5 mb-5 bg-light rounded shadow-sm" id="withdraw"
      ...
      <div class="card border-info mb-4">
        ...
        @endforeach
            ...
            <button type="button" id="withdraw-button" class="btn btn-primary w-100" onClick="handleWithdraw()">
              Submit Withdrawal
            </button>
          </form>
        </div>
    ...
    <section class="d-none home-section container p-4 bg-light rounded shadow-sm" id="home" style="height: 1000px">
      <!-- User Info -->
      <div class="text-center mb-4">
        <img src="https://placehold.co/100" alt="User Logo" class="rounded-circle mb-2 profile-pic"
          style="width: 100px; height: 100px" />
        <h3 class="text-primary UserName">UserName</h3>
        <p class="text-secondary"><strong>Balance:</strong>
        <p class="user-balance">$100</p>
        </p>
      </div>
    ...
    <section class="d-none earn-section container p-4 bg-light rounded shadow-sm" id="earn" style="height: 100vh">
      ...
      <div class="row">
        ...
        <div class="col-md-6 mb-4">
          <div class="card border-primary">
            <div class="card-body">
              <h5 class="card-title text-primary">Reffer And Earn</h5>
              <p class="card-text mb-1">
                <strong>Total Reffers:</strong> <span class="ads-limit-value refferCount"
                  id="refferCount">refferCount</span>
              </p>

              <!-- Start Task Button -->
              <a id="reffer_now" href="" class="btn btn-primary mt-3 w-100">
                Reffer Now
              </a>
              <!--<button id="ad" class="btn btn-primary mt-3 w-100">-->
              <!--  Start Task Adsgram-->
  ...
  <footer
    ...
    <a href="#" onclick="showSection('home')" class="nav-item text-center text-decoration-none text-primary">
      <img src="https://th.bing.com/th/id/R.d4c78c018744a53d7b9bf502ef939e40?rik=5vvMhUTq0TgSEg&pid=ImgRaw&r=0"
        alt="Home Icon" class="nav-icon mb-1" />
      <p class="mb-0" style="font-size: 0.9rem">Home</p>
    </a>
    <a href="#" onclick="showSection('earn')" class="nav-item text-center text-decoration-none text-primary">
      <img src="https://cdn1.iconfinder.com/data/icons/business-charts/512/salary-512.png" alt="Earn Icon"
        class="nav-icon mb-1" />
      <p class="mb-0" style="font-size: 0.9rem">Earn</p>
    </a>
    <a href="#" onclick="showSection('withdraw')" class="nav-item text-center text-decoration-none text-primary">
      <img src="https://icons.veryicon.com/png/o/business/work-circle/withdraw-5.png" alt="Withdraw Icon"
        class="nav-icon mb-1" />
      <p class="mb-0" style="font-size: 0.9rem">Withdraw</p>
    </a>
    <a href="#" onclick="showSection('profile')" class="nav-item text-center text-decoration-none text-primary">
      <img
        ...
        alt="Profile Icon" class="nav-icon mb-1" />
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      if (window.Telegram.WebApp) {
        ...
        console.log("Raw initDataUnsafe:", Telegram.WebApp.initDataUnsafe);
